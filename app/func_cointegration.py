...
# CALCULATE COINTEGRATION WITH JOHANSEN TEST
def calculate_cointegration_vecm(series_1, series_2):
    series_1 = np.array(series_1).astype(float)
    series_2 = np.array(series_2).astype(float)
    coint_flag = 0
    #...........
...
def store_cointegration_results(df_market_prices):
    ...
    # RETURN RESULT
    print("Cointegrated pairs succesfuly saved")
    return "saved"
